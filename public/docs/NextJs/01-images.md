...
Next.js will [automatically determine](#image-sizing) the `width` and
...
The `width` and `height` attributes are used to infer the correct aspect
...
A loader is a function that generates the URLs for your image. It
