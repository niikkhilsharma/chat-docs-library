Parallel Routing allows you to simultaneously or conditionally render
...
\`\`\`tsx filename="app/layout.tsx" switcher 'use client'
...
> More information on modals is covered in the [Intercepting
