...
-   First, the value of `sizes` is used by the browser to determine
...
The quality of the optimized image, an integer between `1` and `100`,
...
This must point to a file relative to the root of your Next.js
