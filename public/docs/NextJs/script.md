...
A path string specifying the URL of an external script. This can be
...
`afterInteractive` scripts can be placed inside of any page or layout
...
To use `worker` as a strategy, the `nextScriptWorkers` flag must be
