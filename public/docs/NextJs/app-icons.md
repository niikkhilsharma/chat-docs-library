The `favicon`, `icon`, or `apple-icon` file conventions allow you to set
...
`tsx filename="app/shop/[slug]/icon.tsx" switcher export default function Icon({ params }: { params: { slug: string } }) {   // ... }`
