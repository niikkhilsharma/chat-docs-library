There are a few ways you can handle redirects in Next.js. This page will
...
export async function createPost(id: string) { try { // Call database }
...
export async function middleware(request: NextRequest) { // Get the path
