The Next.js Compiler, written in Rust using [SWC](https://swc.rs/),
...
> **Good to know**: In Next.js, all JavaScript files in `pages`
...
If you're using a custom Babel setup, [please share your
